...
\tableofcontents*
\chapter*{Preface}
In this manual we describe the \textcolor{nicered}{TBKOSTER} code. 
...
\noindent
\textbf{The manual contains:}

\noindent
$\bullet$ Background theory for magnetic Tight-Binding with several atoms per unit-cell, periodic boundary conditions and overlaps.

\noindent
$\bullet$ Installation guide

\noindent
$\bullet$ Instructions to run the code

\noindent
$\bullet$ \textcolor{nicered}{TBKOSTER} process and post-process options.

\noindent
$\bullet$ Description of input and output files.

\mainmatter
\chapter{Background theory}

$\bullet$ \textbf{General TB formalism} with several atoms per unit-cell, non-collinear magnetism, overlap integrals and periodic boundary conditions is described thoroughly in file \href{https://fr.overleaf.com/read/hvmmbjspmtcg#e8c298}{\textcolor{blue}{TB.pdf}}.

\vspace{0.5cm}
\noindent
$\bullet$ \textbf{NRL TB} Hamiltonian is described in the review paper:
\href{http://dx.doi.org/10.1016/j.crhy.2015.12.014}{\textit{An efficient magnetic tight-binding method for transition metals and alloys} C. Barreteau, D. Spanjaard, MC Desjonqueres Comptes Rendus Physique \textbf{17} 406-429 (2016).}

\vspace{0.5cm}
\noindent
$\bullet$ \textbf{Magnetic Force Theorem (MFT)} and its application to the calculation of magneto-crystalline anisotropy can be found in:
\href{http://dx.doi.org/10.1103/PhysRevB.88.214413}{\textit{Magnetocrystalline anisotropy energy of Fe(001) and Fe(110) slabs and nanoclusters: A detailed local analysis within a tight-binding model} D. Li, A. Smogunov, C. Barreteau, F. Ducastelle, and D. Spanjaard Phys. Rev. B \textbf{88} 214413 (2013).}

\vspace{0.5cm}
\noindent
$\bullet$ \textbf{TB spin dynamics} is described in
\href{https://doi.org/10.1103/PhysRevB.103.235436}{\textit{Spin dynamics from a constrained magnetic tight-binding model} Ramon Cardias, Cyrille Barreteau, Pascal Thibaudeau, and Chu Chun Fu Phys. Rev. B \textbf{103}, 235436 (2021).}
...
\section{linux directory}

The "linux" directory should contain...

\section{running TBKOSTER}

\textcolor{nicered}{TBKOSTER} needs an \verb+in_master.txt+ file to run. 
...
The file  \verb+in_master.txt+ is the main input file of \textcolor{nicered}{TBKOSTER}.
